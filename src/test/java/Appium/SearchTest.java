...
// Create an instance of AndroidDriver for testing on Android platform// connect to the local Appium server running on a different machine
// We will use WebElement type for testing the Web application
        driver = new AndroidDriver(new URL(
                "http://192.168.1.103:4723/wd/hub"), caps);
...
// find search box and enter search string
        ...
        Assert.assertEquals(searchItems.size(), 3);
    }
